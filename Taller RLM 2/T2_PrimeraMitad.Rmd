...
La base de datos consta de 205 observaciones de las cuales solo tendremos en cuenta 100, esta contiene variables continuas y categóricas; las observaciones corresponde a caracteristicas de automoviles como lo pueden ser sus caracteristicas fisicas que en este caso serían variables continuas por nombrar algunas tenemos: largo, ancho y altura del automovil; también se le caracterizan según: su fabricante, que tan susceptible es a perdidas y/o daños, número de puertas, entre otras categorias. 
...
**City-mpg.** Las millas por galón es una medida de la distancia promedio recorrida por unidad de energía consumida, puede ser utilizada para comparar el consumo de combustible entre automoviles. Los valores observados de esta variable estan entre 13 mi/gal.us y 49 mi/gal.us

**Body-style.** Esta variable clasifica el automovil según la forma de su carrocería, tendrá tres niveles de medición que se definen como:

* Hatchback En términos de estilo automotriz son vehículos diseñados en dos pilares, en comparación con la mayoria de los sedan estos tienen más capacidad de almacenamiento y tienen un menor consumo de combustible.

* Sedan Son vehículos diseñados en tres pilares, en comparación con los hatchback son mas estables a altas velocidades y el espacio para los pasajeros es más generoso.

* otro en la base de datos se habla tambien de las carrocerias hardtop, wagon y covertibles pero por facilidad el nivel "Otro" estará consituido por estas tres.

**Price** Precio de los autos, será nuestra variable de respuesta, los valores observados de esta variable toman valores entre 5118 y 45400 dólares estadounidenses.
...
Como se observa en la tabla anterior el precio promedio de los automoviles de la muestra es de 13443, con una ddesviación estandar  de 9163.297, tambien podemos ver que el auto de menor precio de la muestra tiene un precio de 5151 y el de mayor precio es de 45400. Por otro lado, el rango intercuartílico es de 9246.5 por lo que podemos anticipar que los datos centrales tienen una fuerte disperción. Destaca que la curtosis es de 5.394072 lo que nos indica que la distribución de nuestra variable tiene colas mas pesadas que la distribución normal, coherente con esto tenemos un coeficiente de asimetría de 1.735634 un indicio de que la ditribución de la variable es asimetrica hacia la derecha, para ver esto mejor realizaremos el respectivo histograma
