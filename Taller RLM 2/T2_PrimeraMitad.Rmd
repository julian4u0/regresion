...
De esta forma, teniendo en cuenta que las pendientes de los modelos son $\beta_1$, $\beta_1 + \beta_{1,1}$ y $\beta_1 + \beta_{1, 2}$, se debe cumplir para que al menos un par de estas tres pendientes sean diferentes para poder establecer que hay diferencias en las tres pendientes ajustadas para cada tipo de vehículo.
