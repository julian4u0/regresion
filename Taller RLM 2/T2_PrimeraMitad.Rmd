...
La base de datos consta de 205 observaciones de las cuales solo tendremos en cuenta 100, esta contiene variables continuas y categoricas; las observaciones corresponde a caracteristicas de automoviles como lo pueden ser sus caracteristicas fisicas que en este caso serían variables continuas por nombrar algunas tenemos: largo, ancho, altura del automovil; también se le caracterizan según: su fabricante, que tan susceptible es a perdidas y/o daños, número de puertas, entre otras categorias. 
Lo que nos interesa es buscar si el *precio* del auto puede ser explicado por la variable continua *City-mpg* y la variable categorica *body-style*, de las cuales haremos una breve descripción a continuación:

**City-mpg.** Las millas por galón es una medida de la distancia promedio recorrida por unidad de energía consumida, puede ser utilizada para comparar el consumo de combustible entre automoviles. esta toma valores entre 13 mi/gal.us y 49 mi/gal.us
...
* Sedan son los modelos de auntos mas comunes que hay...

* otro en la base de datos se habla tambien de las carrocerias hardtop, wagon, covertibles pero por facilidad el nivel "Otro" estara consituido por las tres.

**Price** Precio de los autos sera nuestra variable de respuesta, los valores observados de esta variables toman valores entre 5118 y 45400 ¿dolares?.
