...
$$
F_0 = \frac{[\text{SSE}_{\text{(MR)}}-\text{SSE}_{\text{(MF)}}]/v}{\text{MSE}_{\text{(MF)}}} = \frac{\text{SSR}(I_{1}, I_{2} | X_{1},X_{1}*I_{1}, X_{1} * I_{2})/(c-1)}{\text{MSE}(X_1, I_1, I_2, X_{1}*I_{1}, X_{1} * I_{2})} \\ = \frac{(4280394376-3098866721)/(3-1)}{32966667} = 17.92
$$
...
lh <- linearHypothesis(modelo, c("bodyStylehatchback=0", "bodyStylesedan=0"))
lh
```
