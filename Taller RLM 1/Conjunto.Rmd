...
plot(
  ...
  col = ifelse(x == 34, "red", "black"),
  pch = ifelse(x == 34, 19, 1),
  main = "COVRATIO", 
  sub = "Limite: 0.18"
)
...
diferente, este limite es $0.12$, según hemos visto en clase los limite
...
En la gráfica anterior también podemos observar que los puntos de balanceo
